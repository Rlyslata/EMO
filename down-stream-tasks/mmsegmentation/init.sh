...
echo 'copy [VOC2012] ...'
rsync -av /home/dl/project/EMO/EMO/data/voc/VOCdevkit/VOC2012 /dev/shm/tmp/VOCdevkit
echo '[VOC2012] finished ...'
#rsync -av /home/dl/project/EMO/EMO/data/voc/VOCdevkit/VOC2007 /dev/shm/tmp/VOCdevkit
#echo '[VOC2007] finished ...'

echo 'copy [coco_2017] ...'
rsync -av /home/dl/project/EMO/EMO/data/voc/VOCdevkit/coco2017tovoc /dev/shm/tmp/VOCdevkit
echo '[coco_2017] finished ...'

#echo 'copy [coco_2017] ...'
#mkdir /dev/shm/tmp/VOCdevkit/coco2017tovoc
#python3 copy_coco.py -s /home/dl/project/EMO/EMO/data/voc/VOCdevkit/coco2017tovoc -m train -y 2017 -t 20
